...
public class ShinyEggItem extends Item {
    private static final Random RANDOM = new Random();
    private static final float SHINY_SPAWN_CHANCE = 35.0f; // 35% chance

    public ShinyEggItem(Item.Properties properties) {
        super(properties);
    }
            ...
            if (success) {
                ...
                if (server != null) {
                    ...
                    CustomConsumables.getLogger().info(
                            "Player {} used Shiny Egg successfully! Spawning a shiny Pokémon.",
                ...
                CustomConsumables.getLogger().info(
                        "Player {} used Shiny Egg but failed the roll ({}% vs {}% chance).",
                        player.getName().getString(),
    ...
    public void appendHoverText(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        tooltip.add(new StringTextComponent(TextFormatting.AQUA + "Shiny Egg"));
